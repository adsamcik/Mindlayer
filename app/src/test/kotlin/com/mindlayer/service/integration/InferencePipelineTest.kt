 ...
 * [com.mindlayer.service.ipc.TokenStreamWriter]. The LiteRT-LM
...
class InferencePipelineTest {
    ...
    fun textInference_terminalEventContract() {
        ...
        val helperEvents = events.map { e ->
            com.mindlayer.service.testutil.TestPipeHelper.ParsedEvent(
                kind = e.kind,
                text = e.text,
        ...
        com.mindlayer.service.testutil.TestPipeHelper.assertEventContract(helperEvents)
    }
