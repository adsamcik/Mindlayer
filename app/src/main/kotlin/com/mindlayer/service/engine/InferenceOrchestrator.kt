...
class InferenceOrchestrator(
    ...
    fun cancelInference(requestId: String) {
        ...
        logRepository?.log(com.mindlayer.service.logging.LogEntry(
            ...
            category = com.mindlayer.service.logging.LogCategory.INFERENCE,
            event = com.mindlayer.service.logging.LogEvent.REQUEST_CANCEL,
            requestId = requestId,
                ...
                while (accumulatedToolCalls.isNotEmpty() && toolCallRound < MAX_TOOL_ROUNDS) {
                    ...
                    for (call in pending) {
                        ...
                        logRepository?.log(com.mindlayer.service.logging.LogEntry(
                            timestampMs = System.currentTimeMillis(),
                            category = com.mindlayer.service.logging.LogCategory.INFERENCE,
                            event = com.mindlayer.service.logging.LogEvent.TOOL_CALL,
