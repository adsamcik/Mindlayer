...
| `make_feature_graphic.py` | Downscales `feature-graphic-source.png` to 1024×500 and overlays the wordmark. Requires Pillow. Run: `python make_feature_graphic.py`. |
